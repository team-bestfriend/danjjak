<template>
  <div
    ...
    style="height: auto; box-shadow: 0 8px 40px rgba(0,0,0,0.22);"
    @click.stop
  >
    <div
      class="flex flex-col items-center justify-center gap-2 px-8 pb-8 pt-10"
    ...
    <div class="px-5 pb-5 pt-4">
      <p class="mb-2 text-[13px] font-bold uppercase tracking-wide text-[#9CA3AF]">
        업무 안내 · {{ voiceMode === 'FAMILY' ? '가족 음성' : 'AI 음성' }}
      </p>
      ...
      <div class="mt-4 flex gap-2 border-t border-[#EEEEED] pt-4">
        <button
          type="button"
